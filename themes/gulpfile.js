...
var argv = require('yargs')
  ...
  .alias('d', 'domain')
  .default('sync', false)
  .default('theme', ['nyiaarhus'])
  .default('domain', 'nyiaarhus.vm')
  .argv;
...
var gulp = require('gulp-help')(require('gulp'), {
  'afterPrintCallback' : function() {
    ...
    console.log(chalk.cyan('  *') + chalk.green(' gulp watch --theme base --theme blue --domain test.nyiaarhus.vm --sync'));
...
var configuration = {
  ...
  'nyiaarhus': {
    "js": {
      "paths": ['./nyiaarhus/js/*.js', '!./nyiaarhus/js/*.min.*'],
      "dest": './nyiaarhus/js'
    },
    "sass": {
      "paths": './nyiaarhus/scss/**/*.scss',
      'dest': './nyiaarhus/css'
    },
    "twig": {
      "paths": './nyiaarhus/templates/**/*.twig'
    }
  }
};
